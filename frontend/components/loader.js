    ...
    return (
      ...
      >
        <g fill='#000' fillRule='evenodd'>
          <path
            style={{
              animation: `${animation} ${totalLength * 2}s ease ${delay * 0}s infinite`
            }}
          ...
          <path
            style={{
              animation: `${animation} ${totalLength * 2}s ease ${delay * 1}s infinite`
            }}
          ...
          <path
            style={{
              animation: `${animation} ${totalLength * 2}s ease ${delay * 2}s infinite`
            }}
            d='M110 30.5l6.5-14.5H128l-15.7 32.8h-3.5l-8.2-15.3-8.1 15.3H89L73.3 16h11.6l6.6 15L99 15.2h3.5z'
          />
          <path
            style={{
              animation: `${animation} ${totalLength * 2}s ease ${delay * 3}s infinite`
            }}
          ...
          <path
            style={{
              animation: `${animation} ${totalLength * 2}s ease ${delay * 4}s infinite`
            }}
            d='M179.2 48h-11V0h11z'
          />
          <path
            style={{
              animation: `${animation} ${totalLength * 2}s ease ${delay * 5}s infinite`
            }}
          ...
          <path
            style={{
              animation: `${animation} ${totalLength * 2}s ease ${delay * 6}s infinite`
            }}
